...
const providerApiKey = process.env.ALCHEMY_API_KEY || "1yTHJ5WnPoxt-6urKICDh3HrLAbdzMDG";
...
const etherscanApiKey = process.env.ETHERSCAN_API_KEY || "41G7EQ37FX4U6G85WWRNG6A46M5WJJFBQH";
